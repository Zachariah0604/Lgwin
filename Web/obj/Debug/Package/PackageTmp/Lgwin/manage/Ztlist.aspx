<%@ Page Language="C#" AutoEventWireup="true" Inherits="Lgwin_manage_Ztlist" Codebehind="Ztlist.aspx.cs" %>
...
<body style="margin-top:10px">
 ...
 <table width="95%" border="0" cellspacing="0" cellpadding="0" class="border">
  ...
  <tr class="tdbg"><td>请选择栏目：</td>
    <td align="left"><asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" 
