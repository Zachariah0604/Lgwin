<%@ Page Language="C#" AutoEventWireup="true" Inherits="Lgwin_manage_NewsMe" Codebehind="NewsMe.aspx.cs" %>
...
<body style="margin-top:10px">
  ...
  <tr>
    ...
    <td align="right"><asp:Button ID="DelAll" runat="server" Text="批量删除" onclick="DelAll_Click"/>&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Text="批量静态化" onclick="Button1_Click" /></td>
  </tr>
</table>
    ...
    <asp:Repeater ID="NewsList" runat="server">
        <ItemTemplate>
            <tr class="tdbg" onMouseOut="this.className='tdbg'" onMouseOver="this.className='tdbg2'">
              ...
              <td><a href="Article.Aspx?Id=<%# DataBinder.Eval(Container.DataItem, "Id") %>" title="<%#DataBinder.Eval(Container.DataItem, "Title") %>">&gt;&gt; <%#Mystring.lim_withoutPoint(DataBinder.Eval(Container.DataItem, "Title").ToString(),25) %>[<%#Convert.ToDateTime( DataBinder.Eval(Container.DataItem, "Datee")).ToString("MM-dd") %>]</a></td>
