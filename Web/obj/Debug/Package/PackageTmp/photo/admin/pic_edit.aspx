<%@ Page Language="C#" AutoEventWireup="true" Inherits="pic_edit" Codebehind="pic_edit.aspx.cs" %>
...
<script language="javascript" type="text/javascript">
  ...
  <tr>
    ...
    <td class="style1">&nbsp;<asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1"
  ...
  <tr><td><asp:TextBox ID="kuan" runat="server" Width="30px" Height="22px"  Visible="True"
                   >800</asp:TextBox>&nbsp; 
                    </td></tr>
  
  
  
  </table></div><div id="newPreview">
          <asp:Image ID="Image7" runat="server" Height="166px" Width="260px" />
      </div></td>
 ...
 <td class="style2">&nbsp;</td>
  ...
  <tr>
    <td class="style2">&nbsp;</td>
    <td class="style1">&nbsp;<asp:Button ID="Button1" runat="server" 
            OnClick="Button1_Click" Text="修改" Height="21px" />
      <label>
      <input name="Submit" type="button" onclick="MM_goToURL('self','manage.aspx');return document.MM_returnValue" value="返回" />
        ...
        <br />
            ...
            <asp:Label ID="Label_fenlei" runat="server" Visible="False"></asp:Label>
        <asp:Label ID="Label_pic_name" runat="server" Text="pic_name" Visible="False"></asp:Label>
        <asp:Label ID="Label_zhtID" runat="server" Text="Label"></asp:Label>
        <asp:Label ID="Label_lmID" runat="server" Text="Label"></asp:Label>
    </div>
    </form>
</body>
</html>
