<%@ Page Language="C#" AutoEventWireup="true" Inherits="music_edit" Codebehind="music_edit.aspx.cs" %>
...
<body>
 <form id="form1" runat="server">
    ...
    <br />
    <br />
    <asp:Label ID="Label1" runat="server" Text="歌曲："></asp:Label>
    
    <asp:TextBox ID="TextBox1" runat="server" ></asp:TextBox>
  
&nbsp;<p>
        <asp:Label ID="Label2" runat="server" Text="歌手："></asp:Label>
        <asp:TextBox ID="TextBox2" runat="server"  ></asp:TextBox>
    </p>
    <p>
        <asp:Label ID="Label3" runat="server" Text="音乐图片："></asp:Label>
        <asp:FileUpload ID="FileUpload1" runat="server" />&nbsp;&nbsp;&nbsp
        注：如果图片不对，选择正确图片文件，待各操作完成后点击“确认发表”。</p>
         <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
;<p>
        <asp:Label ID="Label7" runat="server" Text="来源："></asp:Label>
