<%@ Page Language="C#" AutoEventWireup="true" Inherits="index3_bh" Codebehind="index3_bh.aspx.cs" %>
...
<body style="font-size:12px;margin-top:0px;margin-left:0px;margin-right:0px">
    ...
    <iframe id="head" src="flash.htm" scrolling="no" frameborder="0" width="100%" height="215px"></iframe>  
       ...
       <br/>
          ...
          <div align="center"> <asp:Image ID="Image5" runat="server"  ImageUrl="" ></asp:Image></div><br/><br/>
