<%@ Page Language="C#" AutoEventWireup="true" Inherits="index3_movie" Codebehind="index3_movie.aspx.cs" %>
...
<body style="font-size:12px;margin-top:0px;margin-left:0px;margin-right:0px">
    ...
    <div style="width:990px;margin-left:auto;margin-right:auto">
       ...
       <div  style="margin-left:auto;margin-right:auto;font-size:12px;width:990px" >


       <div style="width:100%;margin-left:auto;margin-right:auto;">
       <div style="width:650px;margin-left:10px;margin-right:10px;float:left;min-height:600px">
       <div>
       <div style="text-align:center">
       <div>
       <span style=" line-height:30px;font-weight:bolder;font-size:16px;">
           <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
       </span></div>
       <span style=" font-weight: lighter; line-height:20px; font-size:12px;">
       导演： <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp&nbsp;
       ...
       <div id="com" style="font-size:12px">
        ...
        <div style="height:5px;width:240px;float:left;text-align:left"> 评论者：<asp:Label ID="Label1" runat="server" Text='<%# Eval("name") %>'></asp:Label></div>
      ...
      <span style="text-align:left;margin-left:3px">发表评论</span><div>
       ...
       <div class="s6" > </div>
       <div style="width:300px;height:780px;float:left;"><iframe  name="iframe1"style="width:300px;height:780px;" src="right.aspx" scrolling="no" frameborder="0" ></iframe>
       
       </div>
       <div style="height:40px;width:990px" > </div>
