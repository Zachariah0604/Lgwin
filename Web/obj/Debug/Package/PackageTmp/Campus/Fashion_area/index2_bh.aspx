<%@ Page Language="C#" AutoEventWireup="true" Inherits="index2_bh" Codebehind="index2_bh.aspx.cs" %>
...
<body style="font-size:12px;margin-top:0px;margin-left:0px;margin-right:0px">
    ...
    <ItemTemplate>
         ...
         <div style="width:120px;height:150px;float:left">
            <a href="<%# "index3_bh.aspx?id=" + Eval("ID").ToString() %>"><img  border="0" src="<%# DataBinder.Eval(Container.DataItem,"picurl").ToString() %>" alt="<%# DataBinder.Eval(Container.DataItem,"title").ToString() %>" style="width:100px;height:120px;margin-top:30px;margin-left:8px;margin-right:2px" /></a>
         </div>
          ...
          <tr><td style="width:215px;height:15px;text-align:left">         <a href='<%# "index3_bh.aspx?id=" + Eval("ID").ToString() %>' target="_blank" title='<%# Eval("title")%>'><%# SubStr(DataBinder.Eval(Container.DataItem,"title").ToString(),15) %></a>
</td></tr>
