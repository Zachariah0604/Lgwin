<%@ Page Language="C#" AutoEventWireup="true" Inherits="music_list" Codebehind="music_list.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>时尚广角——音乐 ——列表</title>
        ...
        时尚广角——音乐 ——列表
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="title" HeaderText="歌曲" SortExpression="title" />
                <asp:BoundField DataField="author" HeaderText="歌手" 
                ...
                <asp:BoundField DataField="datee" HeaderText="时间" SortExpression="datee" />
                 <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="music_edit.aspx?id={0}" 
