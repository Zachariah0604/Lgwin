<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TouGao.aspx.cs" Inherits="Lgwin.TouGao.TouGao" %>
            ...
            <div id="text_top_left">
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 5px;
                    ...
                    <tr height="36" style="line-height: 36px;">
                        <td>
                            &nbsp;<span class="style1">*</span>&nbsp;所属分类：&nbsp;<asp:DropDownList ID="bigclass"
                                runat="server" Width="90" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"
                                AutoPostBack="true">
