<%@ Page language="c#" Inherits="Asp600.AboutAdmin.AdminCounter.admin_counter_os" Codebehind="admin_counter_os.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" > 

<html>
  <head>
    <title>admin_counter_os</title>
		...
		<form id="Form1" method="post" runat="server">
			<table class="table" style="BORDER-COLLAPSE: collapse" borderColor="#6595d6" cellSpacing="0"
				...
				<tr>
                    ...
                    <td width="49%"><font color="#333333">操作系统 累计： </font> <%=SumCount%></td>
