<%@ Page language="c#" Inherits="Asp600.AboutAdmin.AdminCounter.admin_counter_browser" Codebehind="admin_counter_browser.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>admin_counter_browser</title>
	...
	<body leftMargin="0" topMargin="0">
		<form id="Form1" method="post" runat="server">
					...
					<td width="60%">
						<DIV align="left"><br>
							<table width="500" border="0" align="center" cellpadding="2" cellspacing="1" bordercolor="#6595d6"
								bgcolor="#6595d6">
								<tr>
									<td height="30" align="center" bgcolor="#e2e9ff"><font color="#990000">
											站点访问统计系统</font></td>
								</tr>
								<tr>
									<td height="231" align="center" valign="top" bgcolor="#ffffff">
										<table width="490" border="0" align="center" cellspacing="0">
											<tr>
												<td width="49%"><font color="#333333">浏览器 累计： </font>
												<%=SumCount%></td>
            ...
            <tr> 
              <td style="height: 22px"><div align="center">没有任何数据</div></td>
            </tr>
          </table><%
									}
									else
