<%@ Page Language="C#" AutoEventWireup="true" Inherits="movie_edit" Codebehind="movie_edit.aspx.cs" %>
...
<body>
 <form id="form1" runat="server">
    ...
    <br />
    <br />
    <asp:Label ID="Label1" runat="server" Text="电影："></asp:Label>
...
&nbsp;<p>
    ...
    <p>
        ...
        注：如果图片不对，选择正确图片，待各操作完成后点击“确认发表”。</p>
