<%@ Page Language="C#" AutoEventWireup="true" Inherits="shuyu_comlist" Codebehind="shuyu_comlist.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>时尚广角——书余——评论列表</title>
</head>
<body>
    ...
    <Columns>    
        ...
        <asp:BoundField DataField="correct" HeaderText="是否发表" />   
        <asp:BoundField DataField="datee" HeaderText="日期" /> 
        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="shuyu_com.aspx?id={0}" 
