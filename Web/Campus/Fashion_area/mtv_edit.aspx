<%@ Page Language="C#" AutoEventWireup="true" Inherits="mtv_edit" Codebehind="mtv_edit.aspx.cs" %>
...
&nbsp;<p>
       ...
       <p>
        <asp:Label ID="Label3" runat="server" Text="视频图片："></asp:Label>
