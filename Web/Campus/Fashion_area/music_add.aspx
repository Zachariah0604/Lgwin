<%@ Page Language="C#" AutoEventWireup="true" Inherits="music_add" Codebehind="music_add.aspx.cs" %>
...
<body>
    ...
    <br />
    <br />
    <asp:Label ID="Label1" runat="server" Text="歌曲名："></asp:Label>
    ...
    <p>
      ...
      <p>
        ...
        <asp:FileUpload ID="FileUpload1" runat="server" />上传gif格式的图片
    &nbsp; </p>
    <p>
    <p>
        <asp:Label ID="Label3" runat="server" Text="音频文件："></asp:Label>
