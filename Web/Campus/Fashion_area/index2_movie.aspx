<%@ Page Language="C#" AutoEventWireup="true" Inherits="index2_movie" Codebehind="index2_movie.aspx.cs" %>
...
<body style="font-size:12px;margin-top:0px;margin-left:0px;margin-right:0px">
   ...
   <div style="background-image:url(images/tushu_images/tushu_16.gif);width:743px;height:24px" align="left" ><table style="margin-left:0px"><tr><td style="width:50px"></td><td style="width:100px;font-size:medium;">
        电影</td><td style="width:100px"></td><td style="width:493px"></td></tr></table></div>
         <div class="s6"></div>
    ...
    <ItemTemplate>
         ...
         <div style="width:120px;height:150px;float:left">
            <a href="<%# "index3_movie.aspx?id=" + Eval("ID").ToString() %>"><img  border="0" src="<%# DataBinder.Eval(Container.DataItem,"picurl").ToString() %>" alt="<%# DataBinder.Eval(Container.DataItem,"title").ToString() %>" style="width:100px;height:110px;margin-top:30px;margin-left:8px;margin-right:2px" /></a>
         </div>
         <div style="width:215px;height:150px;float:left">
          ...
          <tr><td style="width:215px;height:15px;text-align:left">         <a href="<%# "index3_movie.aspx?id=" + Eval("ID").ToString() %>"target="_blank" title='<%# Eval("title")%>'><%# SubStr(DataBinder.Eval(Container.DataItem,"title").ToString(),15) %></a>
</td></tr>
          <tr><td style="width:215px;height:15px;text-align:left"> 导演：<%# DataBinder.Eval(Container.DataItem,"author").ToString() %></td></tr>
