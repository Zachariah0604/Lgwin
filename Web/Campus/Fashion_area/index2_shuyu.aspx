<%@ Page Language="C#" AutoEventWireup="true" Inherits="index2_shuyu" Codebehind="index2_shuyu.aspx.cs" %>
...
<body style="font-size:12px;margin-top:0px;margin-left:0px;margin-right:0px">
   ...
   <div style="background-image:url(images/tushu_images/tushu_16.gif);width:743px;height:24px" align="left" ><table style="margin-left:0px"><tr><td style="width:50px"></td><td style="width:100px;font-size:medium;">
        书余</td><td style="width:100px"></td><td style="width:493px"></td></tr></table></div>
         <div class="s6"></div>
                 <div class="s6"></div>
    ...
    <ItemTemplate>
         ...
         <div style="width:120px;height:150px;float:left">
            <a href="<%# "index3_shuyu.aspx?id=" + Eval("ID").ToString() %>"><img  border="0" src="<%# DataBinder.Eval(Container.DataItem,"picurl").ToString() %>" alt="<%# DataBinder.Eval(Container.DataItem,"title").ToString() %>" style="width:100px;height:110px;margin-top:30px;margin-left:8px;" /></a>
         </div>
          ...
          <tr><td style="width:215px;height:15px;text-align:left">         <a href='<%# "index3_shuyu.aspx?id=" + Eval("ID").ToString() %>' target="_blank" title='<%# Eval("title")%>'><%# SubStr(DataBinder.Eval(Container.DataItem,"title").ToString(),15)%></a>
</td></tr>
          <tr><td style="width:215px;height:15px;text-align:left"> 作者：<%# DataBinder.Eval(Container.DataItem,"author").ToString() %></td></tr>
          <tr><td style="width:215px;height:104px;text-align:left"> <%#SubStr( DataBinder.Eval(Container.DataItem,"content").ToString(),110) %></td></tr>
          <tr><td style="width:215px;height:3px;text-align:left"><hr style="color:#dddddd"></td></tr>
          </table></div>
             ...
             <iframe  name="iframe1"style="width:300px;height:780px;" src="right.aspx" scrolling="no" frameborder="0" ></iframe>
                 ...
                 <div class="s7" style="text-align:center">
                     <asp:Label ID="Label3" runat="server" Text="当前页码为："></asp:Label>
                               [
                                <asp:Label ID="labPage" runat="server" Text="1"></asp:Label>
                                &nbsp;]
                                <asp:Label ID="Label5" runat="server" Text="总页码为："></asp:Label>
                                [
                                ...
                                <asp:LinkButton ID="lnkbtnBack" runat="server" Font-Underline="False" ForeColor="Red"
                                    OnClick="lnkbtnBack_Click">最后一页</asp:LinkButton>&nbsp;&nbsp;</div></div>
