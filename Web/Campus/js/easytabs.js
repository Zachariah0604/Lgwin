...
//Set the id names of your tablink (without a number at the end)
var tablink_idnames = new Array("tablinks")
//Set the id name of your tabcontentarea (without a number at the end)
var tabcontent_idnames = new Array("tabcontents") 
...
function easytabs(menunr, active) 
    {
	 ...
	 function easytab(menunr, active) 
    {
        if (menunr == autochangemenu)
        {
        currenttab=active;
        ...
        for (i=1; i <= tabcount[menunr]; i++)
        {
            document.getElementById(tablink_idnames[menunr]+i).className='tab'+i;
            document.getElementById(tabcontent_idnames[menunr]+i).style.display = 'none';
        }
        document.getElementById(tablink_idnames[menunr]+active).className='tab'+active+' tabactive';
        document.getElementById(tabcontent_idnames[menunr]+active).style.display = 'block';
	}
        var timer; counter=0; 
